...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  try {
	    window.__flintPackages["react-json-tree"] = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"react-json-tree\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()))
	  }
	  catch(e) {
	  ...
	  try {
	    window.__flintPackages["md5-o-matic"] = __webpack_require__(1)
	  }
	  catch(e) {
	    console.log('Error running package!')
	    console.error(e)
