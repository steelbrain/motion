...
export default {
  enter(node, parent, scope) {
    if (node.name.name == 'sync') {
      return [
        t.JSXAttribute(t.stringLiteral('__motionValue'), node.value),
        t.JSXAttribute(t.stringLiteral('__motionOnChange'), t.functionExpression(null, [t.identifier('__motionval__')],
          t.blockStatement([
